...
csgd512_lr001_path = os.path.join(ROOT, 'Mar21_12_13_54_jupyter-chenkaixuan_CIFAR10s56-512-csgd-fixed-16-ResNet18_M-1-0.01-0.0-0.1-0.0-60-6000-6000-666-True.csv')
csgd512_lr002_path = os.path.join(ROOT, 'Mar21_12_14_27_jupyter-chenkaixuan_CIFAR10s56-512-csgd-fixed-16-ResNet18_M-1-0.02-0.0-0.1-0.0-60-6000-6000-666-True.csv')
dsgd512_lr001_path = os.path.join(ROOT, 'Mar21_12_16_46_jupyter-chenkaixuan_CIFAR10s56-512-ring-fixed-16-ResNet18_M-1-0.01-0.0-0.1-0.0-60-6000-6000-666-True.csv')
dsgd512_lr002_path = os.path.join(ROOT, 'Mar21_12_17_12_jupyter-chenkaixuan_CIFAR10s56-512-ring-fixed-16-ResNet18_M-1-0.02-0.0-0.1-0.0-60-6000-6000-666-True.csv')

csgd64_lr001_path = os.path.join(ROOT, 'Mar22_05_56_23_jupyter-guest00_CIFAR10s56-64-csgd-fixed-16-ResNet18_M-1-0.0035-0.0-0.1-0.0-60-6000-6000-666-True.csv')
csgd64_lr002_path = os.path.join(ROOT, 'Mar22_05_57_23_jupyter-guest00_CIFAR10s56-64-csgd-fixed-16-ResNet18_M-1-0.007-0.0-0.1-0.0-60-6000-6000-666-True.csv')
dsgd64_lr001_path = os.path.join(ROOT, 'Mar22_06_00_58_jupyter-guest00_CIFAR10s56-64-ring-random-16-ResNet18_M-1-0.0035-0.0-0.1-0.0-0-6000-6000-666-True.csv')
dsgd64_lr002_path = os.path.join(ROOT, 'Mar22_06_02_19_jupyter-guest00_CIFAR10s56-64-ring-random-16-ResNet18_M-1-0.007-0.0-0.1-0.0-0-6000-6000-666-True.csv')
...
plt.show()
plt.savefig(f'fig_cifar10_resnet18_lamb_01_trainingacc.pdf', format='pdf', bbox_inches='tight')
plt.close()
...
plt.tick_params(labelsize=24)  #调整坐标轴数字大小
plt.show()
plt.savefig(f'fig_cifar10_resnet18_lamb_02_trainingacc.pdf', format='pdf', bbox_inches='tight')
plt.close()
