...
csgd64_seed666_path = os.path.join(ROOT, 'TinyImageNet_Mar16_05_36_31_jupyter-guest00_TinyImageNets56-64-csgd-fixed-16-ResNet18_M-1-0.1-0.0-0.1-0.0-0-6000-6000-666-True.csv')
csgd512_seed666_path = os.path.join(ROOT, 'TinyImageNet_Mar16_05_37_30_jupyter-guest00_TinyImageNets56-512-csgd-fixed-16-ResNet18_M-1-0.8-0.0-0.1-0.0-0-6000-6000-666-True.csv')
dsgd64_seed666_path = os.path.join(ROOT, 'TinyImageNet_Mar16_05_38_27_jupyter-guest00_TinyImageNets56-64-ring-random-16-ResNet18_M-1-0.1-0.0-0.1-0.0-0-6000-6000-666-True.csv')
dsgd512_seed666_path = os.path.join(ROOT, 'TinyImageNet_Mar16_05_39_02_jupyter-guest00_TinyImageNets56-512-ring-random-16-ResNet18_M-1-0.8-0.0-0.1-0.0-0-6000-6000-666-True.csv')
...
plt.show()
plt.savefig(f'fig_tinyimage_resnet18.pdf', format='pdf', bbox_inches='tight')
plt.close()
