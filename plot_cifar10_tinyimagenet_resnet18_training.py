...
csgd64_seed666_path = os.path.join(ROOT, 'Mar15_09_56_57_vipa-111_CIFAR10s56-64-csgd-fixed-16-ResNet18_M-1-0.1-0.0-0.1-0.0-60-6000-6000-666-False.csv')
csgd512_seed666_path = os.path.join(ROOT, 'Mar15_01_56_19_vipa-110_CIFAR10s56-512-csgd-fixed-16-ResNet18_M-1-0.8-0.0-0.1-0.0-60-6000-6000-666-False.csv')
dsgd64_seed666_path = os.path.join(ROOT, 'Mar15_09_57_08_vipa-111_CIFAR10s56-64-ring-fixed-16-ResNet18_M-1-0.1-0.0-0.1-0.0-60-6000-6000-666-False.csv')
dsgd512_seed666_path = os.path.join(ROOT, 'Mar15_01_56_31_vipa-110_CIFAR10s56-512-ring-fixed-16-ResNet18_M-1-0.8-0.0-0.1-0.0-60-6000-6000-666-False.csv')
...
plt.show()
plt.savefig(f'fig_cifar10_resnet18_trainingacc.pdf', format='pdf', bbox_inches='tight')
plt.close()


csgd64_seed666_path = os.path.join(ROOT, 'Mar17_04_50_10_jupyter-guest00_TinyImageNets56-64-csgd-fixed-16-ResNet18_M-1-0.1-0.0-0.1-0.0-0-6000-6000-666-False.csv')
csgd512_seed666_path = os.path.join(ROOT, 'Mar17_04_50_57_jupyter-guest00_TinyImageNets56-512-csgd-fixed-16-ResNet18_M-1-0.8-0.0-0.1-0.0-0-6000-6000-666-False.csv')
dsgd64_seed666_path = os.path.join(ROOT, 'Mar17_04_51_50_jupyter-guest00_TinyImageNets56-64-ring-random-16-ResNet18_M-1-0.1-0.0-0.1-0.0-0-6000-6000-666-False.csv')
dsgd512_seed666_path = os.path.join(ROOT, 'Mar17_04_52_39_jupyter-guest00_TinyImageNets56-512-ring-random-16-ResNet18_M-1-0.8-0.0-0.1-0.0-0-6000-6000-666-False.csv')
...
plt.tick_params(labelsize=24)  #调整坐标轴数字大小
plt.show()
plt.savefig(f'fig_tinyimagenet_resnet18_trainingacc.pdf', format='pdf', bbox_inches='tight')
plt.close()
